...
def swap_APT_to_zUSDC_via_liquidswap(account, APT_amount: int):
...
def swap_zUSDC_to_APT_via_liquidswap(account, zUSDC_amount: int):
    logger = setup_gay_logger('swap_zUSDC_to_APT_via_liquidswap')
...
def swap_APT_to_zUSDT_via_liquidswap(account, APT_amount: int):
    logger = setup_gay_logger('swap_APT_to_zUSDT_via_liquidswap')
...
def swap_zUSDT_to_APT_via_liquidswap(account, zUSDT_amount: int):
    logger = setup_gay_logger('swap_zUSDT_to_APT_via_liquidswap')
