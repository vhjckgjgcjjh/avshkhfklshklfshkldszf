...
def deposit_APT_to_gator(account, APT_amount: int):
    logger = setup_gay_logger('deposit_APT_to_gator')
...
def swap_APT_to_USDC_via_gator(account):
    logger = setup_gay_logger('swap_APT_to_USDC_via_gator')
...
def swap_USDC_to_APT_via_gator(account):
    logger = setup_gay_logger('swap_USDC_to_APT_via_gator')
...
def withdraw_APT_to_gator(account, APT_amount: int):
    logger = setup_gay_logger('withdraw_APT_to_gator')
